...
//Code Here
let evenNumbers  = mixedNumbers.filter(n => n % 2 === 0)
...
//Code Here
let postTaxPrices = prices.map(n => n * 1.07);
...
//Code Here
let totalPopulation = populations.reduce((t, n) => t + n)
...
let bobsTotal = purchases.reduce((t, n) => {
  if(n.owner === "Bob"){
    t + n.price
  }else {
    null
